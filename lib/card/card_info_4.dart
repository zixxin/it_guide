...
import 'card_info_5.dart';
import 'card_info_3.dart';

class CardInfo4Page extends StatefulWidget {
  CardInfo4Page({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _CardInfo4PageState createState() => _CardInfo4PageState();
}

class _CardInfo4PageState extends State<CardInfo4Page> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(
              context,
              MaterialPageRoute(builder: (context) => CardInfo3Page()),
            );
          },
        ),
      ),
            ...
            FloatingActionButton(
                onPressed: () => showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                          content: Text(
                            "카드를 등록하기 위해서는 위의 약관에 동의를 해주셔야해요! 오른쪽 화살표를 눌러 약관을 자세히 읽어보시고 왼쪽의 체크박스를 눌러주세요!",
                            style: TextStyle(
