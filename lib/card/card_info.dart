...
import 'card_camera.dart';

class CardInfoPage extends StatefulWidget {
  CardInfoPage({Key? key, required this.title}) : super(key: key);
  final String title;
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(
              context,
              MaterialPageRoute(builder: (context) => CardCameraPage()),
            );
          },
        ),
        actions: [
