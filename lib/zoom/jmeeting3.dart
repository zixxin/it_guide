...
class JMeeting3 extends StatefulWidget {
  const JMeeting3({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _JMeetingState3 createState() => _JMeetingState3();
}

class _JMeetingState3 extends State<JMeeting3> {
  bool selected1 = true;
  bool selected2 = true;
  bool audioCon = true;
  @override
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const Invite(title: '초대')),
              );
            },
            iconSize: 35,
            color: const Color(0xFFa6a6a6),
