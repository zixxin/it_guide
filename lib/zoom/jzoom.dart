            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.pop(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const MenuPage(title: 'IT 가이드')),
                );
              },
            ),
          ),
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintStyle: const TextStyle(
                            fontSize: 15.2, color: Color(0xFF979797)),
      ...
      children: <Widget>[
        SizedBox(
          ...
          child: ElevatedButton(
              ...
              onPressed: () {},
              child: const Icon(Icons.camera_indoor, size: 35)),
        ),
        SizedBox(
          width: 66,
          height: 66,
          child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const Participate(title: '회의 참여')),
                );
              },
              child: const Icon(Icons.add_box_rounded, size: 35)),
        ),
        SizedBox(
            width: 66,
            height: 66,
            child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                    ...
                    primary: const Color(0XFF0d72eb)),
                onPressed: () {},
                child: const Icon(Icons.calendar_today_rounded, size: 35))),
        SizedBox(
          width: 66,
          height: 66,
          child: ElevatedButton(
              ...
              child: const Align(
                  alignment: Alignment.center,
                  child: Icon(Icons.screen_share, size: 35))),
        )
      ],
    );
  }
