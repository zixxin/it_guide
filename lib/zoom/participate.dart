                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const SizedBox(
                          height: 20,
                          child: Text('초대 링크를 받았다면 다시 링크를 탭하여 회의에 참가하십시오',
                              style: TextStyle(
                                color: Color(0xFF979797),
                              )),
                        ),
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            ...
                            border: Border(
                                top: BorderSide(
                                    width: 0.3, color: Color(0xFFa6a6a6)),
                                bottom: BorderSide(
                                    width: 0.3, color: Color(0xFFa6a6a6)))),
                        child: _audioOff(),
                      ),
          ...
          child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const JMeeting1(title: '회의 화면')),
                );
              },
              child: const Text(
                '참가',
